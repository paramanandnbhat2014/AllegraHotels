...
public partial class StaffManageSystem_Packages : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        packageOffering.Visible = false;
    ...
    protected void showOffering_Click(object sender, EventArgs e)
    {
        packageOffering.Visible = true;
    ...
    protected void ExportToPDFWithFormatting()
    {
        ...
        pdfDoc.Add(new Paragraph("                                                                                   "));
        pdfDoc.Add(new Paragraph("All Packges"));
        pdfDoc.Add(new Paragraph("                                                                                "));
        pdfDoc.Add(table);
        pdfDoc.Add(new Paragraph("                                                                                "));
        pdfDoc.Add(new Paragraph("                                                                                "));
        pdfDoc.Add(new Paragraph("All Offerings"));
        pdfDoc.Add(new Paragraph("                                                                                "));
        pdfDoc.Add(table2);
