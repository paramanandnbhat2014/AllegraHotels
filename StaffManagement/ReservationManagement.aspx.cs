...
public partial class StaffManageSystem_ReservationManagement : System.Web.UI.Page
{
    ...
    protected void currentMonth_Click(object sender, EventArgs e)
    {
        SqlDataSource1.SelectCommand = "Select * from Reservation WHERE MONTH(reservationDate) = MONTH(GETDATE())";
    }

    protected void allMonth_Click(object sender, EventArgs e)
    {
