<%@ Page Title="" Language="C#" MasterPageFile="Home.master" AutoEventWireup="true" CodeFile="ComedyPackage.aspx.cs" Inherits="ComedyPackage" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <h3>Comedy Festival Package</h3>
    <hr />
    <img src="img\comedybanner.jpg" alt="Comedy Festival" style="margin-left: 100px;"/>
    <br />
