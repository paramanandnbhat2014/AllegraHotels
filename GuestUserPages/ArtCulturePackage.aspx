<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="ArtCulturePackage.aspx.cs" Inherits="ArtCulturePackage" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <h3>Melbourne Arts & Culture Package</h3>
    <hr />
    <img src="img\artsdesign.jpg" alt="Arts & Culture" style="margin-left: 100px;"/>
