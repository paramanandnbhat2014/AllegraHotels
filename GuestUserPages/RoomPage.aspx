<%@ Page Title="Allegra Hotel Rooms" Language="C#" MasterPageFile="Home.master" AutoEventWireup="true" CodeFile="RoomPage.aspx.cs" Inherits="Hotel_WebASP_RoomPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
			<div>
			 <h3>Standard Room</h3>
                <hr/>
			 <img src="img/standardslide.jpg"/><br />
&nbsp;<p>Take a step back in time and stay in an inner heritage room. These windowless rooms are perfect for those who need an ambience of tranquility.</p>
