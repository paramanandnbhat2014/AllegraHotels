<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="SpaPackage.aspx.cs" Inherits="SpaPackage" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <h3>East Day Spa Package</h3>
    <hr />
    <img src="img\spa.png" alt="East Day Spa" style="margin-left: 100px;"/>
