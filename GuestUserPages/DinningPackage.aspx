<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="DinningPackage.aspx.cs" Inherits="DinningPackage" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <h3>Evening Dinning Package</h3>
    <hr />
    <img src="img\eveningdining.jpg" alt="Evening Dinning" style="margin-left: 100px;"/>
