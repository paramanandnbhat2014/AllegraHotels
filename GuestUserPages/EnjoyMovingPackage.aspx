<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="EnjoyMovingPackage.aspx.cs" Inherits="EnjoyMovingPackage" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <h3>Enjoy Moving Image Package</h3>
    <hr />
    <img src="img\movigmage.jpg" alt="Moving Image" style="margin-left: 100px;"/>
