<%@ Page Title="" Language="C#" MasterPageFile="Home.master" AutoEventWireup="true" CodeFile="BalconyRoom.aspx.cs" Inherits="RoomBalcony" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <div>
			 <h3>Superior Balcony Room</h3>
                <hr />
			 <img src="img/balconyslide.jpg"/>
			 <p>Located on the 1st floor, all our Superior Balcony rooms open onto a common verandah overlooking 
                 Hay and Milligan Streets cityscape for you to enjoy an evening drink or just to enjoy the fresh 
                 air. These rooms set a sublime mood for a romantic weekend escape.</p>
