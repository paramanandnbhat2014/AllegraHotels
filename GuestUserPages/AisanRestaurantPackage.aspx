<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="AisanRestaurantPackage.aspx.cs" Inherits="AisanRestaurantPackage" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <h3>Aisan Restaurant Package</h3>
    <hr/>
    <img src="img\asianrestaurant.jpg" alt="Aisan Restaurant" style="margin-left: 100px;"/>
